...
public class TerrainGeneration
{
    ...
    private readonly TerrainLighting terrainLighting = new TerrainLighting();
    private TerrainMesh terrainMesh = null!;
    
    public void Start()
    {
        Block.InitializeBlockPrefabs();
        
        terrainMesh = new TerrainMesh(chunks);
    ...
    private void GenerateTerrain(Vector3 centerChunk)
    {
        ...
        foreach (var pos in chunksToGenerate)
        {
            ...
            terrainLighting.GenerateLighting(chunk);
    ...
    public void BreakBlock()
    {
        ...
        terrainLighting.UpdateLightingForBlockChange(chunk, localX, localY, localZ, oldBlock, chunk.Blocks[localX, localY, localZ]);
